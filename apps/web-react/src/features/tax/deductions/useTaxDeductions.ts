...
/**
 * Owns the manual deduction inputs (PPF/ELSS/NPS/other 80C, parents' premium) and combines them
 * with the inferred amounts from the tax summary to produce the 80C / 80CCD(1B) / 80D totals.
 */
