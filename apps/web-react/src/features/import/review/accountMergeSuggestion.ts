...
//
// The `normalize()` heuristic itself now lives in packages/core/src/core/import/importAccountResolution.ts
// (moved 2026-07-xx) since it's also used there to fuzzy-match a source name against REAL EXISTING
// accounts, not just other source names in this file — one shared implementation instead of two
