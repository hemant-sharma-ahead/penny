...
const TOOL_TILES: { label: string; icon: string; color: string; moduleKey: keyof ModuleVisibility; route: string }[] = [
  { label: 'News', icon: 'ti-news', color: '#f59e0b', moduleKey: 'news', route: 'News' },
  { label: 'Calculators', icon: 'ti-math-function', color: '#f97316', moduleKey: 'calc', route: 'Calculators' }
];
