...
// the test/Node runtime). Byte-for-byte copy of workers/auth/src/lib/auth.ts so the groups worker
// verifies exactly what the client's src/core/identity/signedFetch.ts signs. Keep all three in lockstep.
