...
| [Mobile Migration — React Native (Expo)](mobile-migration.md)           | Mobile    | 🚧 Track 0 + 1 ✅ committed. Track 2 (storage+crypto adapters) ✅ verified (bundle inspection + crypto vectors), on-device check owed, not yet committed. Track 3 (UI component port) next (living doc) |
