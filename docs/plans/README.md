...
| [Mobile Migration — React Native (Expo)](mobile-migration.md)           | Mobile    | 🚧 Track 0 ✅ committed. Track 1 (Expo app skeleton) ✅ verified, not yet committed. Track 2 (storage+crypto adapters) next (living doc) |
