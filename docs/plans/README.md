...
| [Database Structure Review + Performance Findings](db-structure-review.md) | TBD       | ✅ Done (2026-08-29) — `apps/web-react` retired, consistency checker + Analytics lazy computation shipped, cached-balance fix deferred |
