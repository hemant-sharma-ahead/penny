...
Personal data is held in memory (an onboarding draft) until the final write — nothing is persisted before encryption is initialized. See [`docs/ROADMAP.md`](../ROADMAP.md) → _Pre-Phase 1.5 Track 2_ for the full design (envelope crypto, identity, pricing-readiness).
