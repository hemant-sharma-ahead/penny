...
/**
 * Owns the CSV-import wizard: format selection, parse + enrich into preview rows, duplicate
 * detection, and persisting the non-duplicate rows. File reading stays in the UI (platform glue);
 * this hook works purely from already-decoded text.
 */
