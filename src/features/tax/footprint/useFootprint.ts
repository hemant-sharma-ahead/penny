...
/**
 * Assembles the income waterfall for the selected financial year: derives gross (FY income
 * transactions → annualised recurring → manual override), applies EPF/statutory levies and the
 * regime-based direct tax (all overridable), estimates indirect tax from that FY's spending, and
 * reconciles consumed money into direct tax / indirect tax / real consumption.
 */
